...
\resumeSubHeadingListStart
    \resumeSubheading
            ...
            \resumeItemListStart
                \resumeItemBF{Research}{Machine Learning \& AI for Scalable CS Education}
                \resumeItemBF{Courses}{Generative AI \& LLMs, Deep Reinforcement Learning, Natural Language Processing, Convex Optimization}
            \resumeItemListEnd
    \resumeSubheading
...
\resumeSubheading
    {Berkeley Artificial Intelligence Research}{Berkeley, CA}{Researcher}{August 2023 – Present}
    \resumeItemListStart
        \resumeItem{Leveraging LLMs to build an AI assistant for intro CS students via a VS Code extension and command line integration}
        \resumeItem{Published paper on the tool's positive effects on office hour loads at NeurIPS’23 Generative AI for Education workshop}
    \resumeItemListEnd
...
\resumeSubHeadingListStart
    ...
    {\textbf{Meta} (Contract Tech Lead)}{February 2024 - Present}
    \resumeItemListStart
