...
\resumeSubheading
    {\href{https://instalily.ai/}{\underline{Instalily.ai}}}{New York City, NY}{Machine Learning Engineer – Platform/ML Infrastructure}{June 2024 – Present}
    \resumeItemListStart
        ...
        \resumeItem{Interfacing directly with clients on-site and managing cloud infra security to reach SOC2 Type 2 \& HIPAA compliance}
    \resumeItemListEnd

\resumeSubheading
    {\href{https://bair.berkeley.edu/}{\underline{Berkeley Artificial Intelligence Research}} (BAIR)}{Berkeley, CA}{AI Researcher – LLM Applications \& Evaluation}{August 2023 – Present}
    \resumeItemListStart
        \resumeItem{Deployed LLM AI programming assistant for 2000+ CS students via VS Code extension \& command line integration}
        \resumeItem{Prompt engineering, designed LLM evaluation frameworks, maintained model \& backend infrastructure, trained deep neural networks using TensorFlow for predicting student performance, and built data pipelines \& visualizations}
...
\resumeSubheading
    {Amazon}{Seattle, WA}{Software Engineer Intern – Fraud Detection Team}{May 2021 – August 2021}
    \resumeItemListStart
        \resumeItem{Designed \& shipped a big-data ingestion \& search service for fraud detection used daily by Amazon threat analysts}
...
\resumeSubHeadingListStart
    ...
    \resumeItemListStart
        \resumeItem{Built a dashboard for SFCM to increase event/concert turnout by parsing, aggregating, and visualizing historical data}
        \resumeItem{Trained \textbf{6} developers with no web dev experience to build a full-stack web app using React, Express, and PostgreSQL}
    \resumeItemListEnd
