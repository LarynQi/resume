...
\resumeSubHeadingListStart
    \resumeSubheading
            {University of California, Berkeley}{}{M.S. Electrical Engineering and Computer Science}{May 2024}
            \resumeItemListStart
    ...
    \resumeSubheading
        ...
        \resumeItemListStart
            \resumeItemBF{Courses}{Combinatorial Algorithms \& Data Structures (Graduate), Randomized Algorithms, Computability \& Complexity Theory, Programming Languages \& Compilers, Machine Learning, Data Science, Operating Systems, Security, Computer Architecture, Probability \& Random Processes, Linear Algebra, Discrete Math, Signals \& Circuits}
...
\resumeSubHeadingListStart
    ...
    {\textbf{BlueConduit} (Contract)}{August 2021 – January 2022}
    \resumeItemListStart
    ...
    \resumeProjectHeading
    {\textbf{Relativity Space} (Contract)}{February 2021 – May 2021}
        \resumeItemListStart
            \resumeItem{Created web app for visualizing real-time time-series data streaming from sensors on rockets into InfluxDB}
...
\begin{itemize}[leftmargin=0.05in, label={}]
    ...
    \textbf{Tools \& Frameworks}: Git, AWS, GCP, Unix, Linux, Docker, Heroku, MongoDB, InfluxDB, React, Vue, Express, Flask, Django, pandas, NumPy, Matplot}
\end{itemize}
